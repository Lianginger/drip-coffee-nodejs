...
const AdAccountInfo = require("../controllers/adAccountInfo");
...
router.get("/api/adAccountId/:adAccountId/adAccountInfo/", AdAccountInfo.find);
router.post("/api/adAccountInfo/insert", AdAccountInfo.insert);
